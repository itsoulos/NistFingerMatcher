#############################################################################
# Makefile for building: NistFingerMatcher
# Generated by qmake (3.1) (Qt 5.15.8)
# Project:  NistFingerMatcher.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile NistFingerMatcher.pro
#############################################################################
...
DESTDIR       = 
TARGET        = NistFingerMatcher


first: all
####### Build rules

NistFingerMatcher:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: NistFingerMatcher.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/yacc.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		NistFingerMatcher.pro
	$(QMAKE) -o Makefile NistFingerMatcher.pro
...
all: Makefile NistFingerMatcher
...
javahandler.o: javahandler.cpp javahandler.h \
		/usr/lib/jvm/default-java/include/jni.h \
		/usr/lib/jvm/default-java/include/linux/jni_md.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o javahandler.o javahandler.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/NistFingerMatcher/bin || mkdir -p $(INSTALL_ROOT)/opt/NistFingerMatcher/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/NistFingerMatcher/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/NistFingerMatcher/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/NistFingerMatcher/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/NistFingerMatcher/bin/ 
